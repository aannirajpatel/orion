...
<head>
    ...
    <!-- Title -->
    <title>Orion Edu-Tech</title>
<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-112328620-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-112328620-1');
</script>
                    ...
                    <div class="col-12 h-100">
                        <div class="header-content h-100 d-flex align-items-center justify-content-between">
                            <div class="academy-logo">
                                <a href="index.php"><img src="img/logo1.png" alt="" height="100px" width="200px"></a>
                            </div>
                    ...
                    <nav class="classy-navbar justify-content-between" id="academyNav">
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li><a href="Category/index.php">Course</a></li>
                        ...
                        <div class="calling-info">
                            <div class="call-center">
                                <a href="tel:+917202998877"><i class="icon-telephone-2"></i> <span>+91 7202 99 88 77</span></a>
                            </div>
                        </div>
                    </nav>
                </div>
                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                ...
                                <h2 data-animation="fadeInUp" data-delay="400ms">Wellcome to our <br>Online Course</h2>
            ...
            <div class="single-hero-slide bg-img" style="background-image: url(img/bg-img/bg-2.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <h4 data-animation="fadeInUp" data-delay="100ms">Get Expert Training @ any Place</h4>
                                <h2 data-animation="fadeInUp" data-delay="400ms">Wellcome to our <br>Online Trainers</h2>
                                <a href="#" class="btn academy-btn" data-animation="fadeInUp" data-delay="700ms">Read More</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="single-top-popular-course d-flex align-items-center flex-wrap mb-30 wow fadeInUp" data-wow-delay="400ms">
                        <div class="popular-course-content">
                            ...
                            <a href="turnjs4/samples/docs/index.html" class="btn academy-btn btn-sm">See More</a>
                        </div>
                        <span class="badge-offer"><b> Free</b></span>
