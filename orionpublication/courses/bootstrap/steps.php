...
<section class="our-blog p-0 m-0 bg-silver" >
    <div class="container work-process  pb-5 pt-5">
        ...
        <h3>Boostrap <span class="site-color">Training Process </span></h3>
    </div>
        <!-- ============ step 1 =========== -->
        <div class="row">
            <div class="col-md-5">
                <div class="process-box process-left" data-aos="fade-right" data-aos-duration="1000">
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <h5>Theory</h5>
                            <p style="text-align:justify">You will learn basic knowledge about bootstrap   </p>
                        </div>
                    </div>
            ...
            <div class="col-md-5">
                <div class="process-box process-right" data-aos="fade-left" data-aos-duration="1000">
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <h5>Practical</h5>
                            <p style="text-align:justify">we provide complete practical sessions, During training session</p>
                        </div>
                    </div>
            ...
            <div class="col-md-5">
                <div class="process-box process-left" data-aos="fade-right" data-aos-duration="1000">
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <h5>Assignments</h5>
                            <p>On every weekend we conduct quiz to make candidates more confident about what they have learnt. </p>
                        </div>
                    </div>
                    <div class="process-line-l"></div>
                </div>
            ...
            <div class="col-md-5">
                <div class="process-box process-right" data-aos="fade-left" data-aos-duration="1000">
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <h5>Exam</h5>
                            <p>You have to give an exam to get your certificate</p>
                        </div>
                    </div>
                    <div class="process-line-r"></div>
                </div>
            ...
            <div class="col-md-5">
                <div class="process-box process-left" data-aos="fade-right" data-aos-duration="1000">
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <h5>Certification</h5>
                            <p>You will get certification </p>
                        </div>
                    </div>
                    <div class="process-line-l"></div>
                </div>
