<?php
/**
 * Written by Aan (aancodes@gmail.com) at Global BizConnect on 18/5/19 4:32 PM.
 */
...
if (isset($_POST['title'])) {
    ...
    if(!authToEditResource($con,$rid) || !isResource($con, $rid, RES_YOUTUBE)){
    ...
    <br>
    <div class="container">
        <h3>YouTube Link Successfully Updated!</h3>
        <hr>
