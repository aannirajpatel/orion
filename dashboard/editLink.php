<?php
/**
 * Written by Aan (aancodes@gmail.com) at Global BizConnect on 18/5/19 3:46 PM.
 */
    ...
    <div class="container">
        ...
        if (isset($_GET['rid'])) {
            ...
            if (mysqli_num_rows($getResResult) > 0) {
                ...
                $cid = $getResData['cid'];
                echo "<h3>Editing link</h3><hr>";
                ?>

                <div class="container">
                    <form class="form-horizontal" method="post" action="editLinkHandler.php">
                        <fieldset>
                            <!-- Text input-->
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input id="title" name="title" type="text"
                                           ...
                                           placeholder="Edit link title" class="form-control input-md"
                                           required="">
